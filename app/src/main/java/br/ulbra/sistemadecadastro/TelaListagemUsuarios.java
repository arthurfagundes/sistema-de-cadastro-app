...
public class TelaListagemUsuarios {
    ...
    public void CarregarTela() {
        ...
        act.setContentView(R.layout.activity_list);
        ...
        txtnome = (TextView) act.findViewById(R.id.txtnomelist);
        txtendereco = (TextView) act.findViewById(R.id.txtenderecolist);
        txttelefone = (TextView) act.findViewById(R.id.txttelefonelist);
